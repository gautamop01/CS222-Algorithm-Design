...
#include<bits/stdc++.h>    // Include the standard C++ library header files
...
string SCS(string s1, string s2) {
    ...
    return scs + s1.substr(i) + s2.substr(j);     // Add the remaining characters of both strings to the SCS string and return it
}
...
int main(){
    ...
    cin>>str2;
    cout << "Longest Common Subsequence: " << LCS(str1, str2) << endl;
    cout << "Shortest Common Supersequence: " << SCS(str1, str2) << endl;
